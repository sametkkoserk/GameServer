...
namespace Runtime.Contexts.MiniGames.Command
{
    public class SendMapCommand : EventCommand
    {
        ...
        {
            SendPacketToLobbyVo<MiniGameMapGenerationVo> vo = (SendPacketToLobbyVo<MiniGameMapGenerationVo>)evt.data;

            Message message = Message.Create(MessageSendMode.Reliable, (ushort)ServerToClientId.SendMiniGameMap);
