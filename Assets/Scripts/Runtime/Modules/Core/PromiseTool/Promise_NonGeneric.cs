...
using System.Linq;
using Runtime.Modules.Core.PromiseTool.Exceptions;
using UnityEngine;

namespace Runtime.Modules.Core.PromiseTool
{
  /// <summary>
  ...
  public interface IPromise
  {
    ...
    /// <summary>
    /// Cancels promise
    /// Removes all callbacks and sets its state to cancelled so nothing happend even if operation completes
    /// </summary>
    void Cancel();
  }
...
//            Argument.NotNull(() => exception);
  ...
  public class Promise : IPromise, IPendingPromise, IPromiseInfo
  {
    ...
    /// </summary>
    public PromiseState CurState { get; set; }
...
//            Argument.NotNull(() => rejectable);
      ...
      if (CurState == PromiseState.Cancelled)
        return;
...
//            Argument.NotNull(() => onRejected);
      ...
      Action<Exception> rejectHandler = ex =>
      {
        ...
        {
          Debug.LogError(callbackException.Message);
...
//            Argument.NotNull(() => ex);
      ...
      Promise promise = new Promise(PromiseState.Rejected);
